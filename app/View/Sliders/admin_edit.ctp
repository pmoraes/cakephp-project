	...
	<div class="col-md-12">
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				<?php echo $this->Form->create('Slider', array('class' => 'form-horizontal form-groups-bordered','type' => 'file'));?>
					<?php echo $this->Form->hidden('id');?>
					<div class="form-group <?php echo $this->Form->error('Slider.name') ? 'has-error' : ''?>">
						<label for="field-1" class="col-sm-3 control-label">Nome</label>	
						<div class="col-sm-5">
							<?php echo $this->Form->text('name', array('class' => 'form-control'));?>
							<?php if ($this->Form->error('Slider.name')): ?>
								<span class="has-error"><?php echo $this->Form->error('Slider.name')?></span>	
							<?php endif; ?>
						</div>
					</div>
					
					<div class="form-group <?php echo $this->Form->error('Slider.weight') ? 'has-error' : ''?>">
						<label for="field-2" class="col-sm-3 control-label">Peso</label>
						<div class="col-sm-5">
							<?php echo $this->Form->text('weight', array('class' => 'form-control', 'type' => 'number'));?>
							<?php if ($this->Form->error('Slider.weight')): ?>
								<span class="has-error"><?php echo $this->Form->error('Slider.weight')?></span>	
							<?php endif; ?>
						</div>
					</div>
